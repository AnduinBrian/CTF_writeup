...
for x in range(filesize):
    f = BitVec("f%d"%x, 16)
    s.add(And(f >= ord(" "), f <= ord("~")))
    flag.append(f)

def bv32(n):
    return Concat(Extract(7, 0, flag[n + 3]), 
           Extract(7, 0, flag[n + 2]), 
           Extract(7, 0, flag[n + 1]), 
           Extract(7, 0, flag[n + 0])
           )
...
s.add(bv32(52) ^ 425706662 == 1495724241)
s.add(bv32(17) - 323157430 == 1412131772)
s.add(bv32(59) ^ 512952669 == 1908304943)
s.add(bv32(28) - 419186860 == 959764852)
s.add(bv32(66) ^ 310886682 == 849718389)
s.add(bv32(10) + 383041523 == 2448764514)
s.add(bv32(37) + 367943707 == 1228527996)
s.add(bv32(22) ^ 372102464 == 1879700858)
s.add(bv32(46) - 412326611 == 1503714457)
s.add(bv32(70) + 349203301 == 2034162376)
s.add(bv32(80) - 473886976 == 69677856)
s.add(bv32(3) ^ 298697263 == 2108416586)
s.add(bv32(41) + 404880684 == 1699114335)
