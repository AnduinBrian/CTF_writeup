...
With the hint, we can easy find the hitag2crack in proxmark3 git repo. There are crack1, 2, 3, 4 and 5. The author of first 4 is Kevin Sheldrake - he gave an excellent talk about cracking hitag2 crypto at 44CON 2017 ([should watch !!](https://youtu.be/abx1hQDCKyg?si=jOf9Ig_jUpA0jmmm)). But from the hint, I went straight to crack5.
